...
public class UtilityFunctions {
    ...
    /**
     * Scale a joystick value to smooth it for motor control.
     * Square results in finer control a slow speeds, but less aggresive than
     * the cube version.
     */
    ...
    public static double ScaleMotorLookTable(double joyStickPosition) {
        ...
        double[] lArray = { 0.00d, 0.05d, 0.09d, 0.10d, 0.12d, 0.15d, 0.18d, 0.24d, 0.30d, 0.36d, 0.43d, 0.50d, 0.60d,
                0.72d, 0.85d, 1.00d, 1.00d
        };
     ...
     * Written with the color sensor in mind, but could be applicable to the gyro as
     * well.
     * Example:
